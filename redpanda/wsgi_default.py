...
# python
sys.path.append('/d2/python_venv/3.8/redpanda/lib/python3.8/')
sys.path.append('/d2/python_venv/3.8/redpanda/lib/python3.8/site-packages/')
# django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'redpanda.settings.production')
